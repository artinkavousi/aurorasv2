...
var testMatch = (match, testId) => typeof match === "string" && minimatch(testId, match) || match instanceof RegExp && match.test(testId) || Array.isArray(match) && match.some((m) => testMatch(m, testId));

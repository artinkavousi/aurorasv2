...
var VERSION = new Semver("2.0.0-beta.2");
...
var PlainView = class {
  constructor(doc, config) {
    const cn2 = ClassName(config.viewName);
    this.element = doc.createElement("div");
...
var Point3d = class {
  ...
  static isObject(obj) {
    ...
    const y2 = obj.y;
    const z = obj.z;
    if (typeof x !== "number" || typeof y2 !== "number" || typeof z !== "number") {
      return false;
    }
    return true;
  }
...
var Point4d = class {
  ...
  static isObject(obj) {
    ...
    const z = obj.z;
    const w = obj.w;
    if (typeof x !== "number" || typeof y2 !== "number" || typeof z !== "number" || typeof w !== "number") {
      return false;
    }
    return true;
  }
...
var TpButtonGridEvent = class extends TpEvent {
...
var ButtonGridApi = class extends BladeApi {
  constructor(controller) {
    super(controller);
...
var ButtonGridController = class {
  constructor(doc, config) {
...
var ButtonGridBladeController = class extends BladeController {
  constructor(doc, config) {
...
var ButtonGridBladePlugin = createPlugin({
  id: "buttongrid",
  type: "blade",
  accept(params) {
    const result = parseRecord(params, (p) => ({
...
var CubicBezierApi = class extends BladeApi {
  get label() {
    return this.controller.labelController.props.get("label");
  }
  set label(label) {
...
var CubicBezierPickerView = class {
  constructor(doc, config) {
    this.element = doc.createElement("div");
...
var className$5 = ClassName("cbzg");
function compose(h1, h2) {
  return (input) => h2(h1(input));
}
var CubicBezierGraphView = class {
  constructor(doc, config) {
    this.element = doc.createElement("div");
...
var PREVIEW_DURATION = 1e3;
var className$4 = ClassName("cbzprv");
var CubicBezierPreviewView = class {
  constructor(doc, config) {
    this.stopped_ = true;
    this.startTime_ = -1;
...
var CubicBezierGraphController = class {
  constructor(doc, config) {
    this.onKeyDown_ = this.onKeyDown_.bind(this);
    this.onKeyUp_ = this.onKeyUp_.bind(this);
    this.onPointerDown_ = this.onPointerDown_.bind(this);
...
var CubicBezierPickerController = class {
  constructor(doc, config) {
    this.value = config.value;
    this.viewProps = config.viewProps;
...
var CubicBezierController = class {
  constructor(doc, config) {
    this.onButtonBlur_ = this.onButtonBlur_.bind(this);
    this.onButtonClick_ = this.onButtonClick_.bind(this);
    this.onPopupChildBlur_ = this.onPopupChildBlur_.bind(this);
...
var CubicBezierBladePlugin = createPlugin({
  id: "cubicbezier",
  type: "blade",
  accept(params) {
    const result = parseRecord(params, (p) => ({
...
var FpsGraphBladeApi = class extends BladeApi {
  get fps() {
...
var FpsGraphBladeController = class extends BladeController {
  constructor(doc, config) {
...
var FpsGraphBladePlugin = createPlugin({
  id: "fpsgraph",
  type: "blade",
  accept(params) {
    const result = parseRecord(params, (p) => ({
...
var RangeSliderController = class {
  constructor(doc, config) {
    this.grabbing_ = null;
    this.grabOffset_ = 0;
    this.onPointerDown_ = this.onPointerDown_.bind(this);
...
var RangeSliderTextController = class {
  constructor(doc, config) {
    this.value = config.value;
    this.viewProps = config.viewProps;
...
var IntervalInputPlugin = createPlugin({
  id: "input-interval",
  type: "input",
...
var TpRadioGridChangeEvent = class extends TpChangeEvent {
...
var RadioGridApi = class extends BladeApi {
  constructor(controller) {
    super(controller);
    this.cellToApiMap_ = /* @__PURE__ */ new Map();
    const gc = this.controller.valueController;
...
export {
  ...
  CubicBezierGraphController,
  CubicBezierGraphView,
  CubicBezierPickerController,
